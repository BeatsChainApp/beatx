          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                disabled={loading}
                className="w-full bg-white border-2 border-gray-300 text-gray-700 py-4 px-6 rounded-xl hover:border-blue-400 hover:bg-blue-50 disabled:opacity-50 font-medium transition-all duration-200 flex items-center justify-center gap-3 shadow-sm hover:shadow-md"
              >
              ...
              <button
                ...
                disabled={loading}
                className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-4 px-6 rounded-xl hover:from-purple-700 hover:to-blue-700 disabled:opacity-50 font-medium transition-all duration-200 shadow-md hover:shadow-lg flex items-center justify-center gap-3"
              >
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
              <p className="text-xs text-blue-700 text-center">
                <span className="font-medium">Admin Access:</span> Use info@unamifoundation.org with Google Sign-In for admin privileges
              </p>
            </div>
          </div>
        </div>
