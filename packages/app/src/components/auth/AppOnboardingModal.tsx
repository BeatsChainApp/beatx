        ...
        <div className="p-4 sm:p-6">
          ...
          {currentStepName === 'account' && (
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Sign Up / Sign In to Continue</h3>
              <p className="text-gray-600 mb-8">
                Sign up with Google to create your account, access all features, and sync your data across devices
              </p>
