/**
 * App Onboarding Manager - Web App Version (SECURE)
...
class AppOnboardingManager {
    ...
    createStepContent(container, stepName) {
        ...
        // Create step content based on step name without innerHTML
        switch (stepName) {
            case 'welcome':
    ...
    getStepContent(stepName) {
        const contents = {
            welcome: `
                <div class="app-onboarding-step">
                    <div class="step-header">
                        <div style="font-size: 48px; margin-bottom: 16px;">🎵</div>
                        <h2>Welcome to BeatsChain Marketplace</h2>
                        <p>Transform your music into NFTs • Submit to radio stations • Generate professional ISRC codes</p>
                    </div>
                ...
                <div class="app-onboarding-step">
                    ...
                    <div class="step-content">
                        <div class="account-benefits">
                            <div class="benefit-item">✅ Secure profile management</div>
                            <div class="benefit-item">✅ Cross-device sync</div>
                            <div class="benefit-item">✅ Marketplace access</div>
    ...
    // Sponsor integration methods (adapted from extension)
